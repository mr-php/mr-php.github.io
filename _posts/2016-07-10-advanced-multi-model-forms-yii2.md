...
Manage multiple models in a form, supporting validation for each model. For a multi child model see [advanced-multi-hasmany-model-forms-yii2](advanced-multi-hasmany-model-forms-yii2).
